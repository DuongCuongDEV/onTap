package com.example.cuongdvph20635_thi11;
...
import com.example.cuongdvph20635_thi11.adapter.taskAdapter;
import com.example.cuongdvph20635_thi11.model.task;
import com.example.cuongdvph20635_thi11.netWorking.API;
import com.example.cuongdvph20635_thi11.view.AddTaskActivity;
            ...
            public void onclickDeleteItem(task task) {
                ...
                builder.setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        apiService.deleteTask(task.getId()).enqueue(new Callback<com.example.cuongdvph20635_thi11.model.task>() {
                            @Override
                            public void onResponse(Call<com.example.cuongdvph20635_thi11.model.task> call, Response<com.example.cuongdvph20635_thi11.model.task> response) {
                                taskList.remove(task);
                                taskAdapter.notifyDataSetChanged();
                            }

                            @Override
                            public void onFailure(Call<com.example.cuongdvph20635_thi11.model.task> call, Throwable t) {
